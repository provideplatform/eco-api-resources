...
export function batch<DeSerializersT extends DeSerializers>(
  ...
  return new ODataBatchRequestBuilder(
    defaultOpApiInboundDeliverySrv0002Path,
...
export function changeset<DeSerializersT extends DeSerializers>(
  first:
    | undefined
    | WriteOpApiInboundDeliverySrv0002RequestBuilder<DeSerializersT>
    | Array<WriteOpApiInboundDeliverySrv0002RequestBuilder<DeSerializersT>>,
  ...rest: Array<WriteOpApiInboundDeliverySrv0002RequestBuilder<DeSerializersT>>
): BatchChangeSet<DeSerializersT> {
  return new BatchChangeSet(transformVariadicArgumentToArray(first, rest));
}

export const defaultOpApiInboundDeliverySrv0002Path =
