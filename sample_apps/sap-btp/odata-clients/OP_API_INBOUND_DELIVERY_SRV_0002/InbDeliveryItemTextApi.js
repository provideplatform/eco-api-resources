...
exports.InbDeliveryItemTextApi = void 0;
/*
 * Copyright (c) 2023 SAP SE or an SAP affiliate company. All rights reserved.
 *
 * This is a generated file powered by the SAP Cloud SDK for JavaScript.
 */
const InbDeliveryItemText_1 = require("./InbDeliveryItemText");
const InbDeliveryItemTextRequestBuilder_1 = require("./InbDeliveryItemTextRequestBuilder");
const odata_v2_1 = require("@sap-cloud-sdk/odata-v2");
class InbDeliveryItemTextApi {
    constructor(deSerializers = odata_v2_1.defaultDeSerializers) {
        this.entityConstructor = InbDeliveryItemText_1.InbDeliveryItemText;
    ...
    requestBuilder() {
        return new InbDeliveryItemTextRequestBuilder_1.InbDeliveryItemTextRequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(InbDeliveryItemText_1.InbDeliveryItemText, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', InbDeliveryItemText_1.InbDeliveryItemText)
            };
        }
        return this._schema;
    }
}
exports.InbDeliveryItemTextApi = InbDeliveryItemTextApi;
//# sourceMappingURL=InbDeliveryItemTextApi.js.map