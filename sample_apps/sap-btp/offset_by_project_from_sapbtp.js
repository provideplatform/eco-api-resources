...
import { service } from "./odata-clients/CorporateProductFootprintAnalyticsODataV1";
...
var SAP_BTP_DESTINATION = {}    

SAP_BTP_DESTINATION.destinationName = process.env.SAP_BTP_DESTINATION;


const pfmAPI = service();

// TIP use the filter criteria
// https://sap.github.io/cloud-sdk/docs/js/features/odata/v4-client#getall-request-builder
const productFootprints = pfmAPI.ProductFootprintsRequestBuilder().getAll().execute(SAP_BTP_DESTINATION);
